...
Incident number:&nbsp;  &nbsp;
<input type="text" name="in2" id='in2' value='<?php echo $details[0]['inc_id']; ?>' disabled="disabled"><br />

Classification: &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; 
<select name="type2" id="type2" required value='<?php echo $details[0]['inc_type']; ?>'><br /><br />
