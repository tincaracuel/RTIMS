      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="functions">
          <ul class="nav navbar-nav">
            ...
            <li>
                <a href="<?php echo base_url() ?>index.php/incidentsTableManager/planned_incidents" id="selected">
    ...
    <div id="lowerbox">
        ...
        <?php
            ...
            if($query_planned == NULL){ ?>
                    <center><?php echo '<br /><br /><br /><br /><br />There are no planned activities saved in the database.<br /><br />'; ?>
                    </center>
                    <?php
            }else{ ?>
