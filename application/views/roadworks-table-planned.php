      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="functions">
          <ul class="nav navbar-nav">
            ...
            <li>
                <a href="<?php echo base_url() ?>index.php/roadworksTableManager/planned_roadworks" id="selected">
        ...
        <div id="table_view" style="width: 100%;" >
            ...
            <?php
                ...
                if($query_planned == NULL){ ?>
                    <center><?php echo '<br /><br /><br /><br /><br />There are no planned roadworks saved in the database.<br /><br />'; ?>
                    </center>
                    <?php
                }else{ ?>
